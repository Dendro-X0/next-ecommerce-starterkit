...
export function ShopHome(): JSX.Element {
  ...
  const disableFeatured: boolean = (process.env.NEXT_PUBLIC_DISABLE_FEATURED ?? "false").toLowerCase() === "true"
  const disableTopSelling: boolean = (process.env.NEXT_PUBLIC_DISABLE_TOP_SELLING ?? "false").toLowerCase() === "true"
  const disableBrowseCategories: boolean = (process.env.NEXT_PUBLIC_DISABLE_BROWSE_CATEGORIES ?? "false").toLowerCase() === "true"
  const disableTestimonials: boolean = (process.env.NEXT_PUBLIC_DISABLE_TESTIMONIALS ?? "false").toLowerCase() === "true"
  const disableNewsletter: boolean = (process.env.NEXT_PUBLIC_DISABLE_NEWSLETTER ?? "false").toLowerCase() === "true"
  return (
    <main>
